...
- Using IDE built-in plugin system:
  ...
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>Marketplace</kbd> > <kbd>Search for "Github-Theme-for-JetBrains-IDEs"</kbd> >
  <kbd>Install Plugin</kbd>
  
- Manually:

  Download the [latest release](https://github.com/Megadash452/Github-Theme-for-JetBrains-IDEs/releases/latest) and install it manually using
